...
To download LightningCash Core, visit [lightningcash-gold.com](http://lightningcash-gold.com).
...
Drag LightningCash-Core to your applications folder, and then run LightningCash_gold-Core.

### Need Help?

* See the documentation at the [LightningCash homepage](http://lightningcash-gold.com/)
